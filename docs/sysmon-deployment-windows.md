...
**Next:** [Wazuh Agent Deployment](../wazuh-agent-deployment/wazuh-agent-deployment.md) — enroll `DC01` and `WS01` into the Wazuh manager and confirm log ingestion from both endpoints.
